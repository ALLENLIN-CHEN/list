...
public class Card_3_2Controller {
    ...
    @RequestMapping("/card_3_2_1list")
    @ResponseBody
    public Map<String, Object> getCard_3_2_1list(@RequestParam String year,@RequestParam String p){
        Map<String, Object> data = this.card_3_2Service.getCard_3_2_1list(year,p);
        return data;
    }

    @RequestMapping("/card_3_2_2list")
    @ResponseBody
    public Map<String, Object> getCard_3_2_2list(@RequestParam String year,@RequestParam String p){
        Map<String, Object> data = this.card_3_2Service.getCard_3_2_2list(year,p);
        return data;
    }
}   
