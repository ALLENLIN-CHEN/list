...
//	private Card_3_2RedisDao card_3_2RedisDao;
	...
	public List<Card_3_2> getCard_3_2(int title,String[] p){
		HashMap<String,String> param = new HashMap<String,String>();
		switch (title){
			case 1:{
				if(!p[0].equals("all")){
					param.put("count","year(operation_time) as year,");
					param.put("selectyear","where year(operation_time)="+p[0]);
					param.put("group","year,");
					param.put("order","year,");
				}
				return this.card_3_2Dao.selectCard_3_2_1(param);
			}
			case 2:{
				if(!p[0].equals("all")){
					param.put("count","year(operation_time) as year,");
				...
				return this.card_3_2Dao.selectCard_3_2_2(param);
			}
	...
	public Map<String, Object> getCard_3_2_1ChartOption(){
		...
		List<Card_3_2> lists = getCard_3_2(1,new String[]{"all"});
	...
	public Map<String, Object> getCard_3_2_2ChartOption(){
		Map<String, Object> data = new HashMap<String, Object>();
		Map<String, Object> result = new HashMap<String, Object>();
		List<Card_3_2> lists = getCard_3_2(2,new String[]{"all"});
		List<String> type = new ArrayList<String>();
		List<Integer> person_num = new ArrayList<Integer>();
	...
	public Map<String, Object> getCard_3_3ChartOption(){
		Map<String, Object> data = new HashMap<String, Object>();
		Map<String, Object> result = new HashMap<String, Object>();
		List<Card_3_2> lists = getCard_3_2(3,new String[]{});
	...
	public Map<String, Object> getBigscreen(){
		...
		List<Card_3_2> lists = getCard_3_2(4,new String[]{});
	...
	public Map<String, Object> getCard_3_2_1list(String year,String p){
		int pages = 0;
		Map<String, Object> data = new HashMap<String, Object>();
		List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
		List<Card_3_2> lists = getCard_3_2(1,new String[]{year});

		for(Card_3_2 list:lists){
			Map<String, Object> card_type = new HashMap<String, Object>();
			card_type.put("type",list.getType());
			card_type.put("num",list.getperson_num());
	...
	public Map<String, Object> getCard_3_2_2list(String year,String p){
		int pages = 0;
		Map<String, Object> data = new HashMap<String, Object>();
		List<Map<String, Object>> result = new ArrayList<Map<String, Object>>();
		List<Card_3_2> lists = getCard_3_2(2,new String[]{year});
